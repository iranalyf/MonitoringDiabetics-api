package br.com.monitoringDiabeticsApi.token;
...
public class RefreshTokenPostProcessor implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	@Autowired
	private MonitDiabApiProperty monitDiabProperty;
	...
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter arg1, MediaType arg2,
		...
		// add o refreshTolen em um cookie http
		String refreshToken = body.getRefreshToken().getValue();
		adicionarRefreshTokenNoCookie(refreshToken, req, res);

		// remover refreshToken do body
	...
	private void adicionarRefreshTokenNoCookie(String refreshToken, HttpServletRequest req, HttpServletResponse res) {
		...
		refreshTokenCookie.setSecure(this.monitDiabProperty.getSeguranca().isEnableHttps());
